...
namespace Nop.Services.Installation
{
    ...
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallSampleCustomers()
        {
            ...
            //second user
            var secondUserEmail = "steve_gates@apratim.com";
            ...
            //third user
            var thirdUserEmail = "arthur_holmes@apratim.com";
            ...
            //fourth user
            var fourthUserEmail = "james_pan@apratim.com";
            ...
            //fifth user
            var fifthUserEmail = "brenda_lindgren@apratim.com";
            ...
            //sixth user
            var sixthUserEmail = "victoria_victoria@apratim.com";
        ...
        protected virtual void InstallOrders()
        {
            ...
            //first order
            var firstCustomer = _customerRepository.Table.First(c => c.Email == "steve_gates@apratim.com");
            ...
            var firstOrderItem3 = new OrderItem
            {
                ...
                PriceExclTax = 25M,
                OriginalProductCost = decimal.Zero,
                AttributeDescription = "From: Steve Gates &lt;steve_gates@apratim.com&gt;<br />For: Brenda Lindgren &lt;brenda_lindgren@apratim.com&gt;",
                AttributesXml = "<Attributes><GiftCardInfo><RecipientName>Brenda Lindgren</RecipientName><RecipientEmail>brenda_lindgren@Apratim.com</RecipientEmail><SenderName>Steve Gates</SenderName><SenderEmail>steve_gates@gmail.com</SenderEmail><Message></Message></GiftCardInfo></Attributes>",
                Quantity = 1,
                DiscountAmountInclTax = decimal.Zero,
                DiscountAmountExclTax = decimal.Zero,
                DownloadCount = 0,
            ...
            var firstOrderGiftcard = new GiftCard
            {
                ...
                RecipientEmail = "brenda_lindgren@apratim.com",
                SenderName = "Steve Gates",
                SenderEmail = "steve_gates@apratim.com",
            ...
            //second order
            var secondCustomer = _customerRepository.Table.First(c => c.Email == "arthur_holmes@apratim.com");
            ...
            //third order
            var thirdCustomer = _customerRepository.Table.First(c => c.Email == "james_pan@apratim.com");
            ...
            //fourth order
            var fourthCustomer = _customerRepository.Table.First(c => c.Email == "brenda_lindgren@apratim.com");
            ...
            //fifth order
            var fifthCustomer = _customerRepository.Table.First(c => c.Email == "victoria_victoria@Apratim.com");
        ...
        protected virtual void InstallSettings()
        {
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "https://www.facebook.com/apratim",
                TwitterLink = "https://twitter.com/apratim",
                YoutubeLink = "https://www.youtube.com/user/apratim",
        ...
        protected virtual void InstallNews(string defaultUserEmail)
        {
            ...
            var news = new List<NewsItem>
            {
                new NewsItem
                {
                    ...
                    LanguageId = defaultLanguage.Id,
                    Title = "About Apratim",
                    Short = "It's stable and highly usable. From downloads to documentation, apratim.azurewebsites.net offers a comprehensive base of information, resources, and support to the Apratim community.",
                    Full = "<p>For full feature list go to <a href=\"https://apratim.azurewebsites.net\">Apratim.azurewebsites.net</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow
                },
                new NewsItem
                {
                    AllowComments = true,
                    LanguageId = defaultLanguage.Id,
                    Title = "Apratim new release!",
                    Short = "Apratim includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! Apratim is a fully customizable shopping cart",
                    Full = "<p>Apratim includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                    Published = true,
                    CreatedOnUtc = DateTime.UtcNow.AddSeconds(1)
                },
                new NewsItem
                {
                    ...
                    Short = "The new Apratim store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
