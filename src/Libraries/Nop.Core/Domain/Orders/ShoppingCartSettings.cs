...
namespace Nop.Core.Domain.Orders
{
    ...
    public class ShoppingCartSettings : ISettings
    {
        ...
        //When enabled it can cause one issue: https://apratim.azurewebsites.net/boards/topic/7679/vattax-rounding-error-important-fix
        //When disable it causes another one: https://apratim.azurewebsites.net/boards/topic/11419/nop-20-order-of-steps-in-checkout/page/3#46924
